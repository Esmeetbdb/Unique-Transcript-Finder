...
def t_test(average_list_1, average_list_2):
	...
	stat, p_val = st.ttest_ind(average_list_1, average_list_2, equal_var = equal_var_assumed)
	mean_1 = sum(average_list_1)/len(average_list_1)
	mean_2 = sum(average_list_2)/len(average_list_2)
	#mean_ratio = (sum(average_list_1)/len(average_list_1))/(sum(average_list_2)/len(average_list_2))

	return stat, p_val, mean_1, mean_2
